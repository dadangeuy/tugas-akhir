...
\begin{enumerate}[listparindent=2.5em]
	...
	\par Penulisan anotasi diawali dengan karakter '@', nama anotasi, dan pasangan nama-nilai yang dibungkus dengan tanda kurung. Contoh penggunaan anotasi dapat dilihat pada Kode Sumber \ref{java:annotation}.
	\item Lambda
	...
	\par Penulisan lambda diawali dengan parameter fungsi yang dibungkus dengan tanda kurung, karakter '->', dan implementasi fungsi yang dibungkus dengan kurung kurawal. Contoh penggunaan lambda dapat dilihat pada Kode Sumber \ref{java:lambda}.
\end{enumerate}
\lstinputlisting[label=java:annotation, caption=Contoh Penggunaan Anotasi pada Java, language=Java] {bab2/java/annotation.java}
\lstinputlisting[label=java:lambda, caption=Contoh Penggunaan Lambda pada Java, language=Java] {bab2/java/lambda.java}
...
\lstinputlisting[label=java:scheduling, caption=Contoh Implementasi Scheduling pada Spring, language=Java] {bab2/java/scheduling.java}
