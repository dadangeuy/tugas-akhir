...
\par Tugas akhir ini merupakan pengembangan dari penelitian "Rancang Bangun Aplikasi Push Notification Terpusat". Penelitian tersebut menghasilkan aplikasi yang bernama Push Notification Terpusat. Aplikasi tersebut digunakan untuk mengirim \textit{push notification} ke perangkat pengguna di ITS.
...
\end{figure}
\par Aplikasi terdiri dari 2 modul, yaitu manajemen dan engine. Modul manajemen bertanggung jawab untuk menangani interaksi pengelola dengan sistem lewat halaman berbasis web, sementara modul engine bertanggung jawab untuk mengirimkan \textit{push notification}.
\par Pengembangan yang dilakukan pada tugas akhir ini berfokus di keandalan pengiriman \textit{push notification}, sehingga hanya modul engine saja yang akan mengalami perubahan. 
