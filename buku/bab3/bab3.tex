...
\begin{figure}[H]
	\centering\includegraphics[width=0.6\textwidth]{bab3/img/flowchart-pembuatan_packet.jpg}
...
\begin{figure}[H]
    \centering\includegraphics[width=0.5\textwidth]{bab3/img/flowchart-pengiriman_packet_ke_apns.jpg}
...
\begin{figure}[H]
    \centering\includegraphics[width=0.5\textwidth]{bab3/img/flowchart-pengiriman_packet_ke_fcm.jpg}
...
\begin{figure}[H]
	\centering\includegraphics[width=0.2\textwidth]{bab3/img/flowchart-menampilkan_penggunaan_sumber_daya.jpg}
...
\begin{figure}[H]
	\centering\includegraphics[width=0.2\textwidth]{bab3/img/flowchart-menampilkan_konfigurasi.jpg}
...
\begin{figure}[H]
	\centering\includegraphics[width=0.2\textwidth]{bab3/img/flowchart-menampilkan_log.jpg}
