...
\lstinputlisting[label=yaml:zookeeper, caption=Implementasi Zookeeper] {bab4/yaml/zookeeper.yml}
...
\lstinputlisting[label=yaml:kafka, caption=Implementasi Kafka] {bab4/yaml/kafka.yml}
...
\lstinputlisting[label=code:pembuatan_packet, caption=Implementasi Pembuatan Packet, language=Java] {bab4/java/pembuatan_packet.java}
...
\lstinputlisting[label=code:menambahkan_packet_ke_antrian, caption=Implementasi Menambahkan Packet ke Antrian, language=Java] {bab4/java/menambahkan_packet_ke_antrian.java}
...
\lstinputlisting[label=code:pengiriman_packet_ke_apns, caption=Implementasi Pengiriman Packet ke APNs, language=Java] {bab4/java/pengiriman_packet_ke_apns.java}
...
\lstinputlisting[label=code:pengiriman_packet_ke_fcm, caption=Implementasi Pengiriman Packet ke FCM, language=Java] {bab4/java/pengiriman_packet_ke_fcm.java}
